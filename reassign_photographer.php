...
// code to assign the studio manager
	if (isset($_POST['btn_reassign_p'])) 
	{
		$revid=$_POST['revid'];
		$emid=$_POST['emid'];
		echo $emid;
		echo "$revid";
		$qry_assignment=mysql_query("UPDATE `event_assignment` SET `emp_id`='$emid' WHERE `event_id`='$revid'");

		if ($qry_assignment) 
		{
			$qry_update_status=mysql_query("UPDATE `event_book_list` SET `status`='assigned' WHERE `event_id`='$revid'");
			if ($qry_update_status) 
			{
				echo "<script>
								alert('Photographer Re-Assigned Successfully!..');
...
<div class="inner_content_w3_agile_info two_in">
		<div class="forms-main_agileits" >
				<div class="wthree_general graph-form agile_info_shadow " style="background: url('images/images(13).jpg');background-size:cover; width:70%; text-align:center;">
					<h3 class="w3_inner_tittle two">Re-Assign Photographer</h3>
						<div class="grid-1 ">
							<div class="form-body">
								<form class="form-horizontal" method="post" action="reassign_photographer.php" enctype="multipart/form-data">
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label"></label>
                            				<input type="hidden" name="revid" value="<?php echo $_GET['revid'] ?>">
											<div class="col-sm-6">
			                        ...
			                        <div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label"></label>
										<div class="col-md-6">
											<button type="submit" class="btn btn-default" name="btn_reassign_p">Re-Assign Photographer</button>
										</div>
									</div>
								</form>
							</div>
