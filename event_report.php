...
if (!isset($_SESSION['admin'])) 
{
    ...
    {
        $dei=$_GET['amt'];
        $qry_delete=mysql_query("UPDATE `event_book_list` SET  `money_status` ='Amount Paid' WHERE `event_id`='$dei'");
        if ($qry_delete) 
        {
            echo "<script>
                alert('Amount has been received.');            
                window.location='view_eve_task.php';     
            </script>";
        }
        else
        {
				...
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<ul class="nav navbar-nav">
						    ...
						    <li ><a href="view_salary_details.php">Employee Salary Details</a></li>
						</ul>
				</div>
			</nav>	
	      <!-- //breadcrumbs -->
...
<div class="inner_content_w3_agile_info two_in">
	<div class="forms-main_agileits">
        ...
        <h3 class="w3_inner_tittle two">Accomplished Event Tasks</h3>
			...
			<tbody style="color:blue;background-color: #BFBF7A;">
				<tr>
					<?php
						$qry_select=mysql_query("SELECT * FROM `event_book_list` where `status`='Done'");
					...
					?>
								...
								<td><?php echo $row['strt_date'] ?></td>
								<td><?php echo $row['strt_time'] ?></td>
								...
								<td>
									<?php
										...
										$qry_select_status=mysql_query("SELECT `money_status` FROM `event_book_list` WHERE `event_id`='$event_id'");
									...
									<?php
										...
										{
									?>
						                  <a class="btn btn-warning" href="view_eve_task.php?amt=<?php echo $row['event_id'] ?>">Amount Paid</a>
									<?php
										}
									?>
								</td>
								...
								<td>
									 <a class="btn btn-success" href="print_event.php?eid=<?php echo $row['event_id'] ?>"><i class="fa fa-print"></i></a>
								</td>
