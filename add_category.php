...
if (isset($_POST['btn_add_cat'])) 
{
   $category_name=$_POST['cname'];
    $cat_description=$_POST['cdescription'];
        $qry_insert=mysql_query("INSERT INTO `prod_cat_details`(`cat_id`, `cat_name`,`cat_description`) VALUES ('','$category_name','$cat_description')");
        if ($qry_insert) 
        {
            echo "<script>
					alert('Product Category Details are Added Successfully!...');			
        ...
        else
        {
            ...
            echo "<script>
                    alert('Cannot add this Product Category,Try Again.!');         
	...
	<div class="inner_content_w3_agile_info two_in">
		<div class="forms-main_agileits" >
				<div class="wthree_general graph-form agile_info_shadow " style="background: url('images/images(13).jpg');background-size:cover; width:70%; text-align:center;">
					<h3 class="w3_inner_tittle two">ADD PRODUCT CATEGORY DETAILS</h3>
						<div class="grid-1 ">
							<div class="form-body">
								<form class="form-horizontal" method="post" action="add_category.php" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group">
                        				<label for="focusedinput" class="col-sm-2 control-label"></label>
				                           	<div class="col-sm-8">
				                                <input type="text" class="form-control1" name="cname" id="focusedinput" placeholder="Enter Product Category Name" required="" pattern="[a-zA-Z\s]+" title="Please enter characters only">
				                            </div>
				                    </div>
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label"></label>
											<div class="col-sm-8">
												<input type="text" class="form-control1" name="cdescription" id="focusedinput" placeholder="Describe the Product" required="" pattern="[a-zA-Z\s]+" title="Please enter characters only"> 
											</div>
									</div>
									
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label"></label>
											<div class="col-sm-8">														<button type="submit" class="btn btn-default" name="btn_add_cat">	Add Category</button>
											</div>
									</div>
								</form>
							</div>
