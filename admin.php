...
<body style="background:url('images/rain.jpg');background-size: cover;">
<!-- banner -->
									...
									<a href="#"><i class="fa fa-user" aria-hidden="true"></i>
										<div class="ca-content">
											<h4 class="ca-main one">
												<?php
													 $qry_select=mysql_query("SELECT * FROM `usr_register`");
	                                                   $num_rows=mysql_num_rows($qry_select);
	                                                  echo $num_rows;
	                                            ?> 
	                                        </h4>
											<h3 class="ca-sub one">CUSTOMERS</h3>
										</div>
									</a>
								</li>
									...
									<a href="#"><i class="fa fa-database" aria-hidden="true"></i>
										<div class="ca-content">
											<h4 class="ca-main two">
												<?php
													 $qry_select=mysql_query("SELECT *  FROM `event_book_list`");
	                                                   $num_rows=mysql_num_rows($qry_select);
	                                                  echo $num_rows;
                                                ?> 
											</h4>
												<h3 class="ca-sub two">EVENTS REGISTERED</h3>
										</div>
									</a>
								</li>
									...
									<a href="#"><i class="fa fa-tasks" aria-hidden="true"></i>
										<div class="ca-content">
											<h4 class="ca-main three">
												<?php
													 $qry_select=mysql_query("SELECT *  FROM `prod_ordered_list`");
	                                                   $num_rows=mysql_num_rows($qry_select);
	                                                  echo $num_rows;
                                                ?> 
											</h4>
											<h3 class="ca-sub three">PRODUCT ORDERS</h3>
										</div>
									</a>
								</li>

								<li>
									<a href="#"><i class="fa fa-black-tie" aria-hidden="true"></i>
										<div class="ca-content">
											...
											<h3 class="ca-sub four">TOTAL EMPLOYEES</h3>
										</div>
									</a>
								</li>
								<div class="clearfix"></div>
