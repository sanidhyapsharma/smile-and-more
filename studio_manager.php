            ...
            <div class="inner_content">
                <div class="inner_content_w3_agile_info">
                        <div class="form-group" style="float: right;">
                            <a href="attendance.php" class="btn btn-success">Attendance</a><br><br>
                        </div>
                        <div class="form-group" style="float: right;">
                            <a href="sendnotification.php" class="btn btn-primary ">Send Notification</a>
                        </div>
                        
                        <div class="bottom_agileits_grids">
                        <div class="col-md-4 profile-main">s
                            <div class="profile_bg_agile">
                                <div class="profile-pic wthree">
                                    <?php
                                        $loged_emp=$_SESSION['employee'];
                                        $qry_select_employee=mysql_query("SELECT * FROM `emp_details` WHERE `emp_id`='$loged_emp'");
                                        $row=mysql_fetch_array($qry_select_employee);
                                    ?>
                                    <h2> <?php echo $row['emp_name'];  ?></h2>
                                    <img src="images/admin_icon.png" alt="Image">
                                    <p><?php echo $row['emp_phno'];  ?></p>
                                    <p><?php echo $row['emp_address'];  ?></p>
