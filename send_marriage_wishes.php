...
{
	$textlocal = new Textlocal('sanidhyaelimar@gmail.com', 'Giri@123');

	$numbers=$_POST['phone_number'];
	$numbers = array($numbers);
	$bname=$_POST['bname'];
     $sender = 'TXTLCL';
     $message="Wish You Many Many Happy Birthday  $bname";
 ...
 echo "<script>
 				alert('Message Sent');
				window.location='send_birthday_wishes.php';
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li><a href="send_birthday_wishes.php"><i class="fa fa-server"></i>Birthday Wishes</a></li>
...
<div class="inner_content_w3_agile_info two_in">
	<div class="forms-main_agileits">
        ...
        <h3 class="w3_inner_tittle two">Marriage Anniversary</h3>
			...
			<tbody style="color:blue;background-color: #BFBF7A;">
				<tr>
					<?php
						...
						$qry_select=mysql_query("SELECT * FROM `marriage_event`");
						while ($row=mysql_fetch_array($qry_select)) 
						{
							$mdate=$row['mrg_date'];
							$date = DateTime::createFromFormat("Y-m-d", $mdate);
	                        $mday=$date->format("d");
	                        $mmon=$date->format("M");
								
								if($tday==$mday && $tmon==$mmon)
								{
					?>
                                <form name="f1" action="send_wishes1.php" method="post">
								<td><input type=text name="phone_number" value="<?php echo $row['usr_phno'] ?>" readonly=""></td>
								<td><input type=text name="groom_name" value="<?php echo $row['groom_name'] ?>" readonly=""></td>
								<td><input type=text name="bride_name" value="<?php echo $row['bride_name'] ?>" readonly=""></td>
								<td><input type="submit" name="wishes" value="send wishes"></td>
