					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li><a href="send_marriage_wishes.php"><i class="fa fa-server"></i>Marriage Wishes</a></li>
...
<div class="inner_content_w3_agile_info two_in">
	<div class="forms-main_agileits">
        ...
        <h3 class="w3_inner_tittle two">Birthdays</h3>
			<table class="table table-hover">
    			<thead style="color:red;background-color: #4B4B67;">
				<tr>
					<th>Birthday Boy/Girl Name</th>
					<th>Mobile No</th>
					<th>Send Wishes</th>
			...
			<tbody style="color:blue;background-color: #BFBF7A;">
				<tr>
					<?php
						...
						$qry_select=mysql_query("SELECT * FROM `birthday_event`");
						while ($row=mysql_fetch_array($qry_select)) 
						{
	                        ...
	                        $bmon=$date->format("M");
								...
								if($tday==$bday && $tmon==$bmon)
								{
					?>
                                <form name="f1" action="send_wishes.php" method="post">
								<td><input type=text name="phone_number" value="<?php echo $row['usr_phno'] ?>" readonly=""></td>
								<td><input type=text name="bname" value="<?php echo $row['bir_name'] ?>" readonly=""></td>
