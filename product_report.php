						...
						<ul class="nav navbar-nav">
						    ...
						    <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Tasks Details<span class="caret"></span></a>
							    <ul class="dropdown-menu">
							        <li><a href="event_report.php">Accomplished Events</a></li>
							    </ul>
							</li>
...
<div class="inner_content_w3_agile_info two_in">
	<div class="forms-main_agileits">
        ...
        <h3 class="w3_inner_tittle two">Accomplished Product Orders</h3>
			...
			<tbody style="color:blue;background-color: #BFBF7A;">
				<tr>
					<?php
						$qry_select=mysql_query("SELECT * FROM `prod_ordered_list` where `prod_status`='Done'");
